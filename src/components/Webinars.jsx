...
const Webinars = () => {
  return (
    <section className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-12 sm:px-6 sm:py-16">
      ...
      {/* Vídeo alineado con el texto */}
      <div className="w-full max-w-8xl mb-10 rounded-2xl overflow-hidden shadow-lg relative pb-[56.25%]">
        <iframe 
      ...
      <div className="text-base sm:text-lg text-gray-400 max-w-3xl mb-8 text-center">
        ...
        <p>
          ¡Empieza a transformar tu almacén hoy mismo!
        </p>
      </div>

      {/* Botón de contacto por correo */}
      <a 
        href="mailto:threelogicsapp@gmail.com?subject=Solicitud%20Demo%20ThreeLogics" 
